...
const updateTitle = (title: string | string[], attributes: Object) => {
...
const generateElementAttributesAsString = (attributes: Object) =>
...
const generateTagsAsReactComponent = (type: string, tags: Array<any>) =>
    tags.map((tag, i) => {
        const mappedTag = {
            key: i,
            [HELMET_ATTRIBUTE]: true,
